...
- [ ] Add cross reference (might have use [this](http://stackoverflow.com/questions/19472922/reading-external-sql-script-in-python) approach or [this](https://forum.omz-software.com/topic/3334/mysql-in-pythonista) repo)
